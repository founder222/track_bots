...
export const START_MENU: InlineKeyboardMarkup = {
  inline_keyboard: [
    // [{ text: '🌟 Купить Ограниченное Предложение', callback_data: 'buy_promotion' }],
    [
    ...
    [{ text: 'Обновить', callback_data: 'upgrade' }],
  ],
}
...
export const INSUFFICIENT_BALANCE_SUB_MENU: InlineKeyboardMarkup = {
  inline_keyboard: [
    [{ text: '😺 Ваш Кошелек Бота', callback_data: 'my_wallet' }],
    [{ text: '🔙 Назад', callback_data: 'back_to_main_menu' }],
  ],
}
...
export const USER_SETTINGS_MENU = (botStatus: HandiCatStatus): InlineKeyboardMarkup => {
  return {
    inline_keyboard: [
      [
        {
          text: `${botStatus === 'ACTIVE' ? '⏸️ Приостановить Бота' : '▶️ Возобновить Бота'}`,
